    ...
    <div class="container-fluid">
        ...
        <div class="btn-group ">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><button class="dropdown-item edit-student-btn" value="<?php echo $_SESSION['student_id']; ?>">
                        <i class="fas fa-edit"></i> Manage Account
                    </button></li>
                <li><a class="dropdown-item" href="logout.php" onclick="return confirm('Logout of your account?')"><i
