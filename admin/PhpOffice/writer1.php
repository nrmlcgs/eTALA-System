    ...
    while ($row = $result_check->fetch_assoc()) {
        ...
        if ($result1->num_rows == 7) {
            ...
            while ($row = $result1->fetch_assoc()) {
                ...
                $sheet->setCellValue('G' . $rowNumber, (($row['1st_grading'] !== '') ? number_format($row['1st_grading']) : ''));
                $sheet->setCellValue('H' . $rowNumber, (($row['2nd_grading'] !== '') ? number_format($row['2nd_grading']) : ''));
                $sheet->setCellValue('I' . $rowNumber, (($row['3rd_grading'] !== '') ? number_format($row['3rd_grading']) : ''));
                $sheet->setCellValue('J' . $rowNumber, (($row['4th_grading'] !== '') ? number_format($row['4th_grading']) : ''));
                $sheet->setCellValue('K' . $rowNumber, (($row['final_grade'] !== '') ? number_format($row['final_grade']) : ''));
            ...
            if ($result1->num_rows == 4) {
                ...
                if ($mapeh5 > 0 && $mapeh6 > 0 && $mapeh7 > 0 && $mapeh8 > 0) {
        ...
        if ($result3->num_rows == 7) {
            ...
            while ($row = $result3->fetch_assoc()) {
                ...
                // Set cell values in the Excel sheet
                $sheet->setCellValue('F' . $rowNumber, (($row['1st_grading'] !== '') ? number_format($row['1st_grading']) : ''));
                $sheet->setCellValue('G' . $rowNumber, (($row['2nd_grading'] !== '') ? number_format($row['2nd_grading']) : ''));
                $sheet->setCellValue('H' . $rowNumber, (($row['3rd_grading'] !== '') ? number_format($row['3rd_grading']) : ''));
                $sheet->setCellValue('I' . $rowNumber, (($row['4th_grading'] !== '') ? number_format($row['4th_grading']) : ''));
                $sheet->setCellValue('J' . $rowNumber, (($row['final_grade'] !== '') ? number_format($row['final_grade']) : ''));
        ...
        $fname = $lrn_no . '_' . $lastname . '_' . $firstname . '_' . 'SF 10-JHS.xlsx';
