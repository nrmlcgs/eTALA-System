  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="">
            ...
            <div class="form-group">
                ...
                <input type="text" value= "<?php echo $_SESSION['lrn_no']; ?>" id="inputName" class="form-control" disabled oninput="convertToUpperCase(this)">
            </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="updateName()">Print</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="settingModal" tabindex="-1" aria-labelledby="settingModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="settingModalLabel">Setting</h1>
      </div>
      <div class="modal-body">
      <form action="">
        <div class="row">
        <div class="form-group col-md-4">
            <label for="">Araw:</label>
            <input type="text" name="" id="araw" class="form-control">
            
        </div>
        <div class="form-group col-md-4">
        <label for="">Buwan:</label>
            <input type="text" name="" id="buwan" class="form-control">
        ...
        <div class="form-group col-md-4">
            <label for="">Day:</label>
            <input type="text" name="" id="dday" class="form-control">
            
        </div>
        <div class="form-group col-md-4">
            <label for="">Month:</label>
            <input type="text" name="" id="mmonth" class="form-control">
        ...
        <div class="form-group">
            <label for="inputSName1">Punong-Guro:</label>
            <input type="text" name="inputName1" id="inputSName1" class="form-control">
        </div>
        <div class="form-group">
            <label for="inputSName2">Principal:</label>
            <input type="text" name="inputName2" id="inputSName2" class="form-control">
        </div>
        <div class="form-group">
            <label for="inputSName3">Tagapamanihala ng Paaralan:</label>
            <input type="text" name="inputName3" id="inputSName3" class="form-control">
        </div>
        <!-- Repeat the structure for Signatory 3 and 4 -->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" onclick="updateSignatories()">Update</button>
      </div>
    </div>
  </div>
</div>
...
certificateImg1.src = 'admin/form/Layer_2-nbg.png'; // Replace 'certificate_image_path.png' with your image path
...
centerText('SCHOOLS      BY      THE      DEPARTMENT      OF      EDUCATION,      AND      THEREFORE      IS      AWARDED      THIS', 560);
  ...
  certificateImg.src = 'admin/form/Layer 4.png'; // Replace 'certificate_image_path.png' with your image path
...
certificateImg2.src = 'admin/form/Layer 3.png'; 
...
function updateName() {
  ...
  $.ajax({
    ...
    error: function (xhr, status, error) {
      // Handle errors, log them, or provide user feedback
...
// // Draw underlined text for the student's name
// ctx.font = '48px Times New Roman';
// var studentName = newName;
// var textWidth = ctx.measureText(studentName).width;
// var x = (canvas.width - textWidth) / 2;
// var y = 470;
// // Clear the area where the student name will be drawn
// ctx.clearRect(x, y - 48, textWidth, 48);
// ctx.fillText(studentName, x, y);
// ctx.beginPath();
// ctx.moveTo(x, y + 5); // Underline offset
// ctx.lineTo(x + textWidth, y + 5); // Underline offset
...
function updateSignatories(){
    ...
    drawFormalSignature(sign3, 'Tagapamanihala ng mga Paaralan', 500, 745);
    drawFormalSignature('LOIDA P. ADORNADO, PhD, CESO VI', 'Assistant Schools Division Superintendent', 500, 800);
}
